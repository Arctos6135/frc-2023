...
public class Drivetrain extends SubsystemBase {
    private final CANSparkMax rightMaster = new CANSparkMax(DriveConstants.RIGHT_MASTER, MotorType.kBrushless);
    private final CANSparkMax leftMaster = new CANSparkMax(DriveConstants.LEFT_MASTER, MotorType.kBrushless);
    private final CANSparkMax rightFollower = new CANSparkMax(DriveConstants.RIGHT_FOLLOWER, MotorType.kBrushless);
    private final CANSparkMax leftFollower = new CANSparkMax(DriveConstants.LEFT_FOLLOWER, MotorType.kBrushless);
